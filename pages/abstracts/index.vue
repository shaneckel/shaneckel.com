  ...
  <section>
    ...
    <article class="main">
      <section class="collection">
        <div class="top-asset">
          <figure class="display">
            <img src="/img/modernuntitled_full_1.jpg" alt="">
          </figure>
        </div>
        <div class="content">
      ...
      <section class="collection">
        <div class="top-asset">
          <figure class="display">
            <img src="/img/incomplete_full_1.jpg" alt="">
          </figure>
        </div>
        <div class="content">
          <h3>Incomplete</h3>
      ...
      <section class="collection">
        <div class="top-asset">
          <figure class="display">
            <img src="/img/pittsburghbridges_full_1.jpg" alt="">
          </figure>
        </div>
        <div class="content">
      ...
      <section class="collection">
        <div class="top-asset">
          <figure class="display">
            <img src="/img/untitled_full_1.jpg" alt="">
          </figure>
        </div>
        <div class="content">
          <h3>Untitled</h3>
